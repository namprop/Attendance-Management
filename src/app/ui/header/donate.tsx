                ...
                <div className="flex flex-col items-center gap-4 p-2">
                    ...
                    <div className="relative w-full aspect-4/5 bg-white rounded-xl overflow-hidden shadow-lg border border-gray-100 group">
                        ...
                        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                            <a href={QR_URL} download="hupuna-donate-qr.png" target="_blank" rel="noreferrer" className="bg-white text-gray-800 px-4 py-2 rounded-full font-bold shadow-lg hover:scale-105 transition-transform flex items-center gap-2">
